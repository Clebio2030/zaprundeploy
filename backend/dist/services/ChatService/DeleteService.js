    ...
    for (const message of chat.messages) {
        ...
        if (message.files && Array.isArray(message.files) && message.files.length > 0) {
            ...
            for (const file of message.files) {
                if (file.url) {
                    try {
                        ...
                        const uploadDir = path_1.default.resolve(__dirname, "..", "..", "..", "public");
                        ...
                        const chatFolder = path_1.default.join(uploadDir, `company${companyId}`, "chats");
                        const filePath = path_1.default.join(chatFolder, fileName);
                        ...
                        if (fs_1.default.existsSync(filePath)) {
                            ...
                            if (file.thumbnail && file.thumbnail !== file.url) {
                                ...
                                if (thumbnailNameMatch) {
                                    ...
                                    const thumbnailPath = path_1.default.join(chatFolder, thumbnailName);
            ...
            try {
                ...
                const filePath = path_1.default.join(uploadDir, mediaPath);
